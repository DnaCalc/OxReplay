...
6. expose machine-usable failure classes for invalid bundles, unsupported capabilities, incompatible registries, unstable distillation outcomes, or comparison-view coverage gaps.
